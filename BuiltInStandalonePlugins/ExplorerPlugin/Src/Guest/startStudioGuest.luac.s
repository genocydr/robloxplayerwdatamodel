...
PROTO_2:
  ...
  GETUPVAL R6 3
  CALL R4 2 1
  DUPTABLE R5 K11 [{"openInsertObjectMenu", "listenForVisibilityChanges", "isServiceVisible", "openScript", "triggerFocus", "listenForFocus"}]
  NEWCLOSURE R6 P0
  CAPTURE UPVAL U4
  CAPTURE UPVAL U2
  ...
  CAPTURE UPVAL U8
  CAPTURE UPVAL U2
  SETTABLEKS R6 R5 K9 ["triggerFocus"]
  GETUPVAL R6 9
  SETTABLEKS R6 R5 K10 ["listenForFocus"]
  CALL R1 4 -1
  RETURN R1 -1
