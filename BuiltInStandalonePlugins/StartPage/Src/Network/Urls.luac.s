...
MAIN:
  ...
  CALL R3 0 1
  DUPTABLE R4 K25 [{"EXPERIENCES_SEARCH_URL", "TEMPLATES_SEARCH_URL", "PLACES_SEARCH_URL", "GROUPS_SEARCH_URL", "EXPERIENCES_ICON_URL", "TEAM_CREATE_ACTIVE_SESSION_MEMBERS_URL", "AVATAR_ICON_URL", "MULTI_AGE_RECOMMENDATION", "MULTI_CREATOR_ELIGIBILITY", "MULTI_TEAM_CREATE_STATUS", "ACTIVATE_UNIVERSE", "DEACTIVATE_UNIVERSE", "UNIVERSE_CONFIGURATION", "TEAMCREATE_MEMBERSHIPS"}]
  DUPTABLE R5 K27 [{"Prefix", "Url"}]
  GETTABLEKS R6 R3 K28 ["APIS_URL"]
  SETTABLEKS R6 R5 K26 ["Prefix"]
  DUPCLOSURE R6 K29 [PROTO_0]
  SETTABLEKS R6 R5 K9 ["Url"]
  SETTABLEKS R5 R4 K11 ["EXPERIENCES_SEARCH_URL"]
  DUPTABLE R5 K27 [{"Prefix", "Url"}]
  GETTABLEKS R6 R3 K30 ["DEVELOP_URL"]
  SETTABLEKS R6 R5 K26 ["Prefix"]
  ...
  GETTABLEKS R6 R3 K30 ["DEVELOP_URL"]
  SETTABLEKS R6 R5 K26 ["Prefix"]
  DUPCLOSURE R6 K33 [PROTO_3]
  SETTABLEKS R6 R5 K9 ["Url"]
  SETTABLEKS R5 R4 K14 ["GROUPS_SEARCH_URL"]
  DUPTABLE R5 K27 [{"Prefix", "Url"}]
  GETTABLEKS R6 R3 K34 ["THUMBNAILS_URL"]
  SETTABLEKS R6 R5 K26 ["Prefix"]
  ...
  SETTABLEKS R6 R5 K9 ["Url"]
  SETTABLEKS R5 R4 K24 ["TEAMCREATE_MEMBERSHIPS"]
  RETURN R4 1
